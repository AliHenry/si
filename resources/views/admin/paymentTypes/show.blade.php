    ...
    <div class="main-content page-profile">
        <div class="page-header">
            ...
            <div class="page-actions">
                <a href="{{route('types.edit',$paymentType->id)}}" class="btn btn-primary"><i class="icon-fa icon-fa-edit"></i> Edit Payment Type</a>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-control-plaintext">{{ $paymentType->show ? "True" : "False" }}</p>
                                </div>
                            </div>
                            <hr>
                        </form>
